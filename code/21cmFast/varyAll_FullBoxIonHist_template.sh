...
#PBS -N 21cmSim
#PBS -j eo
#PBS -l mppwidth=384,walltime=10:00:00
#PBS -q premium
#PBS -A m1871
#PBS -m abe
#PBS -M mpresley@berkeley.edu
...
scrape="/global/homes/m/mpresley/KSZ_21cm_Constraints/code/21cmFast/runscripts/scrape_21cm.py"
